export const inpiProcess = {
    siren: {
        ...
        certificate: createInpiCertificateLink
    },
}
...
function getDenomination(snRec) {
    ...
    } else if (typePersonne === 'M' && formality.content.personneMorale?.identite?.entreprise?.denomination) {
...
function createInpiCertificateLink(data) {
    ...
    const url = `https://data.inpi.fr/export/companies?format=pdf&ids=[%22${siren}%22]&est=all&accessPdf=true`
    return url
